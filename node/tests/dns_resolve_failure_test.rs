...
fn dns_resolve_failure_http_response_integration() {
    let mut _node_to_test_against = utils::MASQNode::start_standard("dns_resolve_failure_http_response_integration", None, true);
...
fn dns_resolve_failure_tls_response_integration() {
    let mut _node_to_test_against = utils::MASQNode::start_standard("dns_resolve_failure_tls_response_integration", None, true);
