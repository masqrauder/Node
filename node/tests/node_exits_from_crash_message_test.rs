...
fn node_exits_from_dispatcher_panic_integration() {
    start_node_and_request_crash("node_exits_from_dispatcher_panic_integration", node_lib::dispatcher::CRASH_KEY);
}

#[test]
#[ignore]
fn node_exits_from_accountant_panic_integration() {
    start_node_and_request_crash("node_exits_from_accountant_panic_integration", node_lib::accountant::CRASH_KEY);
}

#[test]
#[ignore]
fn node_exits_from_hopper_panic_integration() {
    start_node_and_request_crash("node_exits_from_hopper_panic_integration", node_lib::hopper::CRASH_KEY);
}

#[test]
#[ignore]
fn node_exits_from_neighborhood_panic_integration() {
    start_node_and_request_crash("node_exits_from_neighborhood_panic_integration",node_lib::neighborhood::CRASH_KEY);
}

#[test]
#[ignore]
fn node_exits_from_proxy_client_panic_integration() {
    start_node_and_request_crash("node_exits_from_proxy_client_panic_integration", node_lib::proxy_client::CRASH_KEY);
}

#[test]
#[ignore]
fn node_exits_from_proxy_server_panic_integration() {
    start_node_and_request_crash("node_exits_from_proxy_server_panic_integration", node_lib::proxy_server::CRASH_KEY);
}

#[test]
#[ignore]
fn node_exits_from_ui_gateway_panic_integration() {
    start_node_and_request_crash("node_exits_from_ui_gateway_panic_integration",node_lib::ui_gateway::CRASH_KEY);
}

#[test]
#[ignore]
fn node_exits_from_stream_handler_pool_panic_integration() {
    start_node_and_request_crash("node_exits_from_stream_handler_pool_panic_integration",node_lib::stream_handler_pool::CRASH_KEY);
}
